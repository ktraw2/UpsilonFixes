...
@Patch.Class("net.minecraft.client.gui.FontRenderer")
@ConfigOptions("fixFontsInTexturePacks")
public class FontRendererTransformer extends UpsilonMiniTransformer {

	@Patch.Method("<init>(Lnet/minecraft/client/settings/OptionsManager;Ljava/lang/String;Lnet/minecraft/client/renderer/RenderEngine;Z)V")
	public void patchConstructor(PatchContext ctx) {
		...
		ctx.add(
			INVOKESTATIC("net/minecraft/client/Minecraft", "instance", "()Lnet/minecraft/client/Minecraft;"),
			GETFIELD("net/minecraft/client/Minecraft", "texturePacks", "Lnet/minecraft/client/texturepacks/TexturePackList;"),
